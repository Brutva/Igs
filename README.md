...
```
cd existing_repo
git remote add origin https://git.itpurple.ru/it-purple-hack/Team/i.g.s.git
git branch -M main
...
* [Set up project integrations](https://git.itpurple.ru/it-purple-hack/Team/i.g.s/-/settings/integrations)
